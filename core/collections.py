...
def get_ages(some_years_of_birth):
	ages = [2019 - year for year in some_years_of_birth]
	return ages
...
def get_first_n_last(some_list):
	return some_list[0:1] + some_list[-1:]
...
def get_list_without_repetition(some_list):
	set_without_repetition = set(some_list)
	list_without_repetition = list(set_without_repetition)
